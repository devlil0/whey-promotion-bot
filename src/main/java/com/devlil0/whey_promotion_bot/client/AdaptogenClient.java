...
@Component
public class AdaptogenClient {

    private final WebClient webClient;

    public AdaptogenClient(WebClient.Builder builder,
                            @Value("${adaptogen.api.base-url}") String baseUrl) {
    ...
    public JsonNode searchWhey(int page, int perPage) {
        try {
            ...
            throw new ExternalApiException("Falha ao consultar Adaptogen", e);
        }
    }
}
